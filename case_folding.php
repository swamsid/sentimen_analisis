                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="70%" class="text-center">Hasil Case Folding</th>
                                            ...
                                            <tbody>
                                            <?php
                                                $sql = "SELECT * FROM case_folding join data_crawling on dc_id = cf_data";
                                            ...
                                            ?>
                                                    <tr class="gradeX">
                                                        ...
                                                        <td class="text-left"><?= $row['cf_case_folding'] ?></td>
        ...
        <div class="modal inmodal" id="modal-detail" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content animated fadeIn">
                    <div class="modal-header" style="padding: 10px;">
                        <span class="modal-title" style="font-size: 14pt; font-weight: 600">Detail Hasil Case Folding</span>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.dataTables-example').on('click', '.btn-detail', function(evt){
                ...
                $('#detail-wrap').load('pages/case_folding/detail.php?id='+ctx.data('id')+'&ctx='+ctx.data('conteks'));
            })
        })
    </script>
