                        ...
                        <div class="col-md-12" style="padding: 0px;">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    ...
                                    <h5>Data Testing Hasil Filtering</h5>
                                </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="70%" class="text-center">Hasil Filtering</th>
                                            ...
                                            <tbody>
                                            <?php
                                                $sql = "SELECT * FROM stopword join tokenize on t_data = s_data join case_folding on cf_data = t_data join data_crawling on dc_id = cf_data";
                                            ...
                                            ?>
                                                    <tr class="gradeX">
                                                        ...
                                                        <td class="text-left"><?= str_replace('|', ' | ', $row['s_stopword']) ?></td>
        ...
        <div class="modal inmodal" id="modal-detail" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content animated fadeIn">
                    <div class="modal-header" style="padding: 10px;">
                        <span class="modal-title" style="font-size: 14pt; font-weight: 600">Detail Hasil Filtering</span>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.dataTables-example').on('click', '.btn-detail', function(evt)
                ...
                $('#detail-wrap').load('pages/filtering/detail.php?id='+ctx.data('id')+'&ctx='+ctx.data('conteks'));
            })
        })
    </script>
