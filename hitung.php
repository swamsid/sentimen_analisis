                            ...
                            .then((resp) => {
                                ...
                                if(resp.data.status == 'berhasil'){
                                    $('#loading').fadeOut(100);
                                        ...
                                        generateTabelNegatifHead(resp.data.dataTraining, resp.data.pNegatif);
                                        ...
                                        generateHitungNegatif(resp.data.totTraining, resp.data.totNegatif, resp.data.pNegatif, resp.data.negatifKeluar, resp.data.words);
            ...
            // generate Body
                $.each(words, function(idx, data){
                    ...
                    $.each(training, function(alpha, train){
                        ...
                        htmlBody += '<td class="text-center">'+counter+'</td>';
                    })
