<?php
    ...
    $sql = "SELECT * FROM stopword join tokenize on t_data = s_data join case_folding on cf_data = t_data join data_crawling on dc_id = cf_data  where t_data = ".$_GET['id'];
