                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                                            <thead>
                                                ...
                                                <th width="5%" class="text-center">No</th>
                                                    ...
                                                    <th width="70%" class="text-center">Hasil Stemming</th>
                                            ...
                                            <tbody>
                                            <?php
                                                $sql = "SELECT * FROM stemmer join stopword on stemmer.s_data = stopword.s_data join tokenize on t_data = stopword.s_data join case_folding on cf_data = t_data join data_crawling on dc_id = cf_data";
                                            ...
                                            ?>
                                                    <tr class="gradeX">
                                                        ...
                                                        <td class="text-left"><?= str_replace('|', ' | ', $row['s_stemmer']) ?></td>
