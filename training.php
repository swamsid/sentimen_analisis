                        ...
                        <div class="col-md-12" style="padding: 0px;">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    ...
                                    <h5>Data Training Yang Sudah Terkumpul</h5>
                                </div>
        ...
        <div class="modal inmodal" id="modal-detail" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content animated fadeIn">
                    <div class="modal-header" style="padding: 10px;">
                        <span class="modal-title" style="font-size: 14pt; font-weight: 600">Detail Data Testing</span>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.btn-detail').click(function(evt){
                ...
                $('#detail-wrap').load('pages/data_training/detail.php?id='+ctx.data('id')+'&ctx='+ctx.data('conteks'));
            })
        })
    </script>
